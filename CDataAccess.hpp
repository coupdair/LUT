...
public:
  ...
  enum ACCESS_STATUS_OR_STATE {STATUS_FREE=0x0,STATUS_FILLED=0x1,STATUS_RECEIVED=0x1,STATUS_PROCESSED=0x2,STATUS_QUEUED=0x3
  , STATE_FILLING=0xF,STATE_RECEIVING=0xE, STATE_STORING=0x5,STATE_SENDING=0x6,STATE_PROCESSING=0x7,STATE_ENQUEUEING=0x8};
